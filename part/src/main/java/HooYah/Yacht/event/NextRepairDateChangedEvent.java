...
public class NextRepairDateChangedEvent extends BasedEvent {
    ...
    public NextRepairDateChangedEvent(Long userId, Part part, OffsetDateTime lastRepairDate) {
        this(part.getId(), userId, part.getYachtId(), part.nextRepairDate(lastRepairDate));
    }
